...
<head>
    ...
    <title>ARCKIPEL | SOLUTIONS DIGITALES</title>
...
<!-- END: Navbar -->
    ...
    <header class="dx-header dx-box-4">
        <div class="bg-image bg-image-parallax">
            <img src="assets/images/bg.jpg" class="jarallax-img" alt="">
            <div style="background-color: rgba(27, 27, 27, .05);"></div>
        </div>
...
<div class="dx-feature dx-feature-1">
    ...
    <div class="dx-feature-cont">
        ...
        <div class="dx-feature-text">Evaluations</div>
    </div>
</div>
